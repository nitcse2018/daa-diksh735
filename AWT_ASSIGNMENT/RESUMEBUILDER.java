...
public class RESUMEBUILDER extends JFrame
{
	...
	public RESUMEBUILDER() 
	{
		...
		lbltitle.setBounds(-86, 11, 625, 40);
		lbltitle.setForeground(new Color(0, 0, 0));
		lbltitle.setBackground(new Color(153, 0, 102));
		lbltitle.setFont(new Font("AR JULIAN", Font.BOLD, 34));
		frame.getContentPane().add(lbltitle);
		
		//Personal Details
		JLabel lbltitle1 = new JLabel("PERSONAL INFORMATION :");
		lbltitle1.setVerticalAlignment(SwingConstants.BOTTOM);
		lbltitle1.setHorizontalAlignment(SwingConstants.CENTER);
		lbltitle1.setBounds(342, 62, 304, 24);
		lbltitle1.setFont(new Font("AR JULIAN", Font.BOLD, 20));
		...
		lbltitle2.setBackground(new Color(240, 248, 255));
		lbltitle2.setFont(new Font("AR JULIAN", Font.BOLD, 18));
		lbltitle2.setBounds(431, 221, 215, 24);
		...
		lbltitle3.setFont(new Font("AR JULIAN", Font.BOLD, 18));
		lbltitle3.setBounds(400, 369, 215, 24);
		...
		b.setFont(new Font("AR JULIAN", Font.BOLD, 15));
